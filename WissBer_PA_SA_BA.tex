...
\newcommand{\titel}{Dokumentation zum Bau eines High-Speed Bierkühlers}
\newcommand{\untertitel}{}	% ggf. Untertitel mit ergänzenden Hinweisen
\newcommand{\arbeit}{Projektarbeit Mikrocomputertechnik}
...
\newcommand{\autor}{Ferdinand Leybach, Maurice Manz, Yannick Schmidt, Simon Straub}
\newcommand{\bearbeitungszeitraum}{22.10.2025 - 13.03.2026}
...
\include{chapter/schaltplan}
\include{chapter/konstruktion}
\include{chapter/software}
\include{chapter/lessons_learned}
