...
Besonderer Wert wurde bei der Entwicklung auf eine kompakte Bauweise, eine klare Struktur der elektronischen Steuerung sowie eine stabile mechanische Umsetzung gelegt. Das 3D-gedruckte Gehäuse ermöglicht eine passgenaue Integration aller Komponenten und bietet gleichzeitig Schutz vor Feuchtigkeit und mechanischen Einwirkungen. Die modulare Bauweise erleichtert zudem Wartung, Anpassung und Weiterentwicklung des Systems. Außerdem ist unser Ziel das Bier nicht durch zu schnelle Drehung zu stark zum schäumen zu bringen, weshalb wir auf PWM setzen, um die richtige Drehgeschwindigkeit zu bekommen. 

Diese Dokumentation beschreibt die Konzeption, Konstruktion und Funktionsweise des Bierkühlers im Detail. Neben den physikalischen Grundlagen werden die mechanische Konstruktion, die elektronische Steuerung, die Programmierung des Mikrocontrollers sowie mögliche Optimierungsansätze erläutert. Um in diesen vielen verschiedenen Projektteilen gut aufgestellt zu sein, haben wir für die verschiedenen Punkte jeweils einen Abteilungschef bestimmt, welcher die jeweilige Abteilung im Auge behält und sich auch hauptsächlich darum kümmert. In diesem Fall sah die Aufteilung wie folgt aus:
